...
/// Shows the shared asset context menu (Open File, Open in Explorer, Open URL,
/// Check if invalid/shared, Copy, Download, Delete, Replace URL) at [position].
///
/// Used by both the URL list rows ([AssetsUrl]) and the PDF thumbnail tiles so
/// they share identical actions.
